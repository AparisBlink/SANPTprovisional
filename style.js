(function (blink) {
	...
	var SANPTprovisionalStyle = function () {
			blink.theme.styles.basic.apply(this, arguments);
		},
		page = blink.currentPage;

	SANPTprovisionalStyle.prototype = {
		//BK-15873 añadimos el estilo basic como parent para la herencia de los estilos del CKEditor
		parent: blink.theme.styles.basic.prototype,
		bodyClassName: 'content_type_clase_SANPTprovisional',
		ckEditorStyles: {
			name: 'SANPTprovisional',
			styles: [
	...
	SANPTprovisionalStyle.prototype = _.extend({}, new blink.theme.styles.basic(), SANPTprovisionalStyle.prototype);

	blink.theme.styles.SANPTprovisional = SANPTprovisionalStyle;
